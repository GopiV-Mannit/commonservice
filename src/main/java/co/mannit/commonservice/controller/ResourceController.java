...
public class ResourceController {
	...
	@GetMapping("eSearch")
	public Response<?> searchResource(@Validated PaginationReqParam paginationReq, @RequestParam(required=false, value="f") String filter)
			throws Exception {
		logger.debug("<searchResource> PaginationReqParam {} userId {}",paginationReq, filter);
		
		
		return Response.buildSuccessMsg(200, "Successfully Searched", searchResource.searchResource(paginationReq, filter));
	}
